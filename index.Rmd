---
title: "Spatiotemporal Patterns in Drug-related EMS Disaptchs NYC: 2013-2017"
---
...
Monthly Frequency of Drug-related EMS Dispatches by Zip Codes

```{r freq_animation}
image_animate(freq_images, fps = 1)
```

Monthly Local Moran's I with False-discovery Rate Correction
